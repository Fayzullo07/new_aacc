            ...
            <header className=''>
                <ul className='text-gray-500 font-semibold flex gap-2'>
                    ...
                    {data_links.map((item, i) => (
                        <li key={i}>
                            <Link href={`/${locale}/admin/events${item.slug}`} className='flex rounded px-3 py-2 hover:text-black hover:bg-gray-50 transition-all'>
