"use client"
import { newGetOneAPI, newPutAPI } from "@/api/AdminRequest";
...
const UpdateNew = ({ params }: { params: any }) => {
    ...
    useEffect(() => {
        if (data) {
            setFormData({
                photo: data.data.news.photo,
                uzTitle: data.data.news.translations.uz.title,
                ruTitle: data.data.news.translations.ru.title,
                enTitle: data.data.news.translations.en.title,
                uzContent: data.data.news.translations.uz.content,
                ruContent: data.data.news.translations.ru.content,
                enContent: data.data.news.translations.en.content,
            });
        }
    }, [data]);
    ...
    return (
        <div className="shadow p-2 bg-white rounded-xl">
            ...
            <div className="mb-5">
                ...
                <TipTap
                    content={data?.data.news.translations.uz.content}
            ...
            <div className="mb-5">
                ...
                <TipTap
                    content={data?.data.news.translations.ru.content}
            ...
            <div className="mb-5">
                ...
                <TipTap
                    content={data?.data.news.translations.en.content}
