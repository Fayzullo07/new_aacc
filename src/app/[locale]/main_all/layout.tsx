        ...
        <div className=" bg-slate-50">
            <div className="md:h-32 border overflow-hidden relative">
                <Image
                    ...
                    alt="Image"
                />
                <h1 className=" absolute md:top-[38%] top-[25%] md:left-[48%] left-[41%] md:text-4xl text-2xl text-white font-semibold drop-shadow-2xl">AACC</h1>
            </div>
            ...
            <div className="lg:px-15 md:px-10 px-0 py-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 md:gap-6">
                    ...
                    <div className="hidden sm:flex">
                        <div className="p-4 bg-white shadow *:cursor-pointer sticky top-24 h-[50vh]">
