        ...
        <>
            {dataItem.map((item: any, i: number) => (
                <div key={i}
                    ...
                    <span className="absolute top-6 z-0 h-16 w-16 rounded-full bg-maincolor transition-all duration-300 group-hover:scale-[11]"></span>
                    <div className="relative z-10">

                        <span className="grid h-16 w-16 place-items-center rounded-full bg-maincolor transition-all duration-300 group-hover:bg-maincolor">
                    ...
                    <div className=" absolute bottom-4  text-base font-semibold leading-7">
                        <p>
                            <Link href={`/${locale}/main_all//services/${item._id}`} className=" text-base flex items-center gap-2 text-maincolor transition-all duration-300 group-hover:text-white">{t("button")}
                                <ArrowRightIcon />
                            </Link>
                        </p>
                    </div>
